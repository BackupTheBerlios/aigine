...
/*					g_pSpaceRunner->m_pGame->m_aCheckPoint[i].m_fMass = ((msg_move*)rd)->checkPoints[i].m_fMass;
					...
					g_pSpaceRunner->m_pGame->m_aCheckPoint[i].m_fRotationFriction = ((msg_move*)rd)->checkPoints[i].m_fRotationFrictions;
...
/*					g_pSpaceRunner->m_pGame->m_aShip[j].m_fMass = ((msg_move*)rd)->ships[j].m_fMass;
					...
					g_pSpaceRunner->m_pGame->m_aShip[j].m_fRotationFriction = ((msg_move*)rd)->ships[j].m_fRotationFrictions;
					g_pSpaceRunner->m_pGame->m_aShip[j].m_iIndex = ((msg_move*)rd)->ships[j].m_iIndex;
					g_pSpaceRunner->m_pGame->m_aShip[j].m_isActive = ((msg_move*)rd)->ships[j].m_isActive;

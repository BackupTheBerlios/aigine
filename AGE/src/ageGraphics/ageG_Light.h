...
*
*/
class ageG_Light : public ageG_LookAtObjects {
 ...
 * 		das licht 'directional (0)' oder 'positional (1)' ist*/
	...
	/***/
	ageG_GraphicPipeline * lnkPipeline;

public:

    //Konstrucktor
    ageG_Light(ageG_GraphicPipeline * lnkPipe);

    /**
     *Konstructor
     * @param Gewünschte Position, und die Blickrichtung in Vectoren
     */
    ageG_Light(ageG_GraphicPipeline * lnkPipe,ageG_Translation3D * position, ageG_Vector3 * lookAt);

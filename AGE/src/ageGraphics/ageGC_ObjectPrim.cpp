...
#include "ageGC_ObjectPrim.h"
ageGC_ObjectPrim::ageGC_ObjectPrim(): AiGinEObject(), fileControl() {
	this->kind = 0;
	this->solid = true;
	this->colorR = 0;
	this->colorG = 0;
...
ageGC_ObjectPrim::ageGC_ObjectPrim(const char* fileName): AiGinEObject(), fileControl(fileName) {
	this->kind = 0;
	this->solid = true;
	this->colorR = 0;
	this->colorG = 0;
...
ageGC_ObjectPrim::~ageGC_ObjectPrim()
{

}
void ageGC_ObjectPrim::display() {
	glPushMatrix();
...
void ageGC_ObjectPrim::setSphere(float radius, int slices, int stacks) {
	this->kind = 1;
	this->radiusSphere = radius;
	this->slicesSphere = slices;
	this->stacksSphere = stacks;
}
void ageGC_ObjectPrim::setCone(float base, float height, int slices, int stacks) {
	this->kind = 2;
	this->baseCone = base;
...
void ageGC_ObjectPrim::setCube(float size) {
	this->kind = 3;
	this->sizeCube = size;
}
void ageGC_ObjectPrim::setTorus(float innerRadius, float outerRadius, int sides, int rings) {
	this->kind = 4;
...
void ageGC_ObjectPrim::setColor(int r,int g,int b) {
	this->colorR = r;
	this->colorG = g;
	this->colorB = b;
}
void ageGC_ObjectPrim::readData() {
	openFile('r');
...
void ageGC_ObjectPrim::writeData() {
	openFile('w');

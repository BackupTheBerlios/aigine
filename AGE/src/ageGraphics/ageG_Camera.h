...
#ifndef AGEG_CAMERA_H
#define AGEG_CAMERA_H
 ...
 * @since 2004-01-07
 */
class ageG_Camera :  public ageG_LookAtObjects {
...
public:
     ...
     */
    ageG_Camera(ageG_Vector3 * position, ageG_Vector3 * lookAtPosiont, ageG_Vector3 * upVector);

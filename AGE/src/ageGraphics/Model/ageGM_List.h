...
public:
    ...
    ////////////////////////////////////////////////////////////////////
    ageGM_List< Type > * nextItem() { return this->_next; }

    ageGM_List< Type > * lastItem() { return this->_before; }

    ////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////
    void addList(ageGM_List< Type > * list)
    {
...
private:
    ...
    ageGM_List< Type > * _tmp;
    //Adresse des nexten knotens
    ageGM_List< Type > * _next;
    //Adresse des vorhergehenden knotens
    ageGM_List< Type > * _before;
};

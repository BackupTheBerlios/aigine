...
* note: 
*/
ageGM_Knot* ageGM_Tree::initKnot(ageGM_Knot* k) {
	k->data = NULL;
	k->left = NULL;
	k->right = NULL;
	return k;
...
* note: 
*/
bool ageGM_Tree::addKnotLeft(ageGM_Knot* paren, ageGM_Knot* child) {
	if(paren != NULL) {
		paren->left = child;
		return true;
	} else {
...
* note: 
*/
bool ageGM_Tree::addKnotRight(ageGM_Knot* paren, ageGM_Knot* child) {
	if(paren != NULL) {
		paren->right = child;
		return true;
	} else {
...
* note: 
*/
ageGM_Knot* ageGM_Tree::getRootKnot() {
	return this->rootKnot;
}

void ageGM_Tree::setRoot(ageGM_Knot* k) {
	this->rootKnot = k;
}
/**
* @description 
...
* note: 
*/
ageGM_Knot* ageGM_Tree::getTemporaryKnot() {
...
* note: 
*/
ageGM_Knot* ageGM_Tree::getKnotPreorder() {
...
* note: 
*/
ageGM_Knot* ageGM_Tree::getKnotInorder() {
...
* note: 
*/
ageGM_Knot* ageGM_Tree::getKnotPostorder() {
...
* note: 
*/
ageGM_Knot* ageGM_Tree::getKnotLevelorder() {
	return NULL;
}
...
* note: 
*/
void ageGM_Tree::buildPreorder(ageGM_Knot* k) {
...
* note: 
*/
void ageGM_Tree::buildInorder(ageGM_Knot* k) {
...
* note: 
*/
void ageGM_Tree::buildPostorder(ageGM_Knot* k) {
...
void ageGM_Tree::buildLevelorder(ageGM_Knot* k) {
}

...
ageGM_Camera::ageGM_Camera() {
    this->upVector = new Vector3D(0.0, 1.0, 0.0);
}

//____________________________________________________________________________
ageGM_Camera::ageGM_Camera(ageGM_Vector3 * position, ageGM_Vector3 * lookAtPosition,
...
void ageGM_Camera::setRotation(int mouseX, int mouseY, int * winSize)
{
...
//____________________________________________________________________________
void ageGM_Camera::moveCamera(float speed)
{
...
//____________________________________________________________________________
void ageGM_Camera::strafeCamera(float speed)
{
    Vector3D temp = * this->getLookAtPosition() - *getTranslation();
...
//____________________________________________________________________________
void ageGM_Camera::moveRight(float speed)
{
    strafeCamera(speed);
}

//____________________________________________________________________________
void ageGM_Camera::moveLeft(float speed)
{
    strafeCamera(-speed);
}

//____________________________________________________________________________
void ageGM_Camera::moveUp(float speed) 
{ 
    getTranslation()->y = getTranslation()->y + speed;
}

//____________________________________________________________________________
void ageGM_Camera::moveDown(float speed)
{
    getTranslation()->y = getTranslation()->y - speed;
}

//____________________________________________________________________________
void ageGM_Camera::moveForward(float speed)
{
    moveCamera(speed);
...
//____________________________________________________________________________
void ageGM_Camera::moveBack(float speed)
{
    moveCamera(-speed);
}
//____________________________________________________________________________
void ageGM_Camera::setViewFogMode(bool trigger, float red, float green, float blue,
...
//____________________________________________________________________________
ageGM_Vector3 * ageGM_Camera::getUpVector() { 
	return upVector;
}
//____________________________________________________________________________
/**

...
#include "ageG_ObjectPrim.h"
ageG_ObjectPrim::ageG_ObjectPrim(): AiGinEObject(), fileControl() {
	this->kind = 0;
	this->solid = true;
	this->colorR = 0;
	this->colorG = 0;
...
ageG_ObjectPrim::ageG_ObjectPrim(const char* fileName): AiGinEObject(), fileControl(fileName) {
	this->kind = 0;
	this->solid = true;
	this->colorR = 0;
	this->colorG = 0;
...
ageG_ObjectPrim::~ageG_ObjectPrim()
{

}
void ageG_ObjectPrim::display() {
	glPushMatrix();
...
void ageG_ObjectPrim::setSphere(float radius, int slices, int stacks) {
	this->kind = 1;
	this->radiusSphere = radius;
	this->slicesSphere = slices;
	this->stacksSphere = stacks;
}
void ageG_ObjectPrim::setCone(float base, float height, int slices, int stacks) {
	this->kind = 2;
	this->baseCone = base;
...
void ageG_ObjectPrim::setCube(float size) {
	this->kind = 3;
	this->sizeCube = size;
}
void ageG_ObjectPrim::setTorus(float innerRadius, float outerRadius, int sides, int rings) {
	this->kind = 4;
...
void ageG_ObjectPrim::setColor(int r,int g,int b) {
	this->colorR = r;
	this->colorG = g;
	this->colorB = b;
}
void ageG_ObjectPrim::readData() {
	openFile('r');
...
void ageG_ObjectPrim::writeData() {
	openFile('w');

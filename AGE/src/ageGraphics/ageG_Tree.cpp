...
* note: 
*/
ageG_Knot* ageG_Tree::initKnot(ageG_Knot* k) {
	k->data = NULL;
	k->left = NULL;
	k->right = NULL;
	return k;
...
void ageG_Tree::setRoot(ageG_Knot* k) {
	this->rootKnot = k;
}
/**
...
* note: 
*/
bool ageG_Tree::addKnotLeft(ageG_Knot* paren, ageG_Knot* child) {
	if(paren != NULL) {
		paren->left = child;
		return true;
	} else {
...
* note: 
*/
bool ageG_Tree::addKnotRight(ageG_Knot* paren, ageG_Knot* child) {
	if(paren != NULL) {
		paren->right = child;
		return true;
	} else {
...
* note: 
*/
ageG_Knot* ageG_Tree::getRootKnot() {
...
* note: 
*/
ageG_Knot* ageG_Tree::getTemporaryKnot() {
...
* note: 
*/
ageG_Knot* ageG_Tree::getKnotPreorder() {
...
* note: 
*/
ageG_Knot* ageG_Tree::getKnotInorder() {
...
* note: 
*/
ageG_Knot* ageG_Tree::getKnotPostorder() {
...
* note: 
*/
ageG_Knot* ageG_Tree::getKnotLevelorder() {
	return NULL;
}
/**
...
* note: 
*/
void ageG_Tree::buildPreorder(ageG_Knot* k) {
...
* note: 
*/
void ageG_Tree::buildInorder(ageG_Knot* k) {

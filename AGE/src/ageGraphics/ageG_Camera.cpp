...
void ageG_Camera::setRotation(int mouseX, int mouseY, int * winSize)
{
...
ageG_Camera::ageG_Camera() {
    this->upVector = new Vector3D(0.0, 1.0, 0.0);
}
ageG_Camera::ageG_Camera(ageG_Vector3 * position, ageG_Vector3 * lookAtPosition,
...
void ageG_Camera::moveDown(float speed)
{
    getTranslation()->y = getTranslation()->y - speed;
}
void ageG_Camera::moveForward(float speed)
{
    moveCamera(speed);

}
void ageG_Camera::moveBack(float speed)
{
    moveCamera(-speed);
}
void ageG_Camera::moveUp(float speed) 
{ 
    getTranslation()->y = getTranslation()->y + speed;
}
void ageG_Camera::moveLeft(float speed)
{
    strafeCamera(-speed);
}
void ageG_Camera::moveRight(float speed)
{
    strafeCamera(speed);
}
ageG_Vector3 * ageG_Camera::getUpVector() { 
	return upVector;
}
void ageG_Camera::setViewFogMode(bool trigger, float red, float green, float blue,
 ...
 */
ageG_Camera::~ageG_Camera() { }
void ageG_Camera::moveCamera(float speed)
{
...
void ageG_Camera::strafeCamera(float speed)
{
    Vector3D temp = * this->getLookAtPosition() - *getTranslation();
